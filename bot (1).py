...
import os
token = '7112257531:AAGBt6EqEAMNYSjFtlAxPAgskU1uR1cfcvA'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = ['5018897945']
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) in subscriber:
		bot.reply_to(message, "Only For ta yoke gyi 🤏")
		return
...
𝒃𝒚 ➜ @Hnineeeeeee ''', reply_markup=mes)
				msg = f'''◆ 𝑪𝑨𝑹𝑫  ➜ {cc} 
◆ 𝑺𝑻𝑨𝑻𝑼𝑺 ➜ 𝘼𝙋𝙋𝙍𝙊𝙑𝙀𝘿 💲💲
◆ 𝑹𝑬𝑺𝑼𝑳𝑻 ➜ 𝘾𝙑𝙑 𝘾𝙃𝘼𝙍𝙂𝙀𝘿 RM5
◆ 𝑮𝑨𝑻𝑬𝑾𝑨𝒀 ➜ 𝙎𝙏𝙍𝙄𝙋𝙀 𝘼𝙐𝙏𝙃
━━━━━━━━━━━━━━━━━
◆ 𝑩𝑰𝑵 ➜ {cc[:6]} - {dicr} - {typ} 
◆ 𝑪𝑶𝑼𝑵𝑻𝑹𝒀 ➜ {cn} - {emj} 
